...
const ProfileBar = () => {
  return (
    <aside id="leftbar" className="d-flex justify-content-center align-items-center leftbar">
            ...
            <p className="position-absolute text_small text-white-50" style={{bottom: 10}}>Developed by <a href="https://codemonga.com" target="_blank" rel='noopener noreferrer'>@codemonga</a></p>
        </aside>
  )
}
