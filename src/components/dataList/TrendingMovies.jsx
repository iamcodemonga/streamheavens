...
const TrendingMovies = () => {
    ...
    return (
        <div className="container-fluid px-md-4">
            ...
            {trendingMovies && trendingMovies.map((movie) => <div className="card movie-card"><Link to="movie"><img src={`https://image.tmdb.org/t/p/w500/${movie.poster_path}`} alt="moviecard_image" /></Link>
                    <div className="card-body px-0">
                    <h6 className="card-title mt-0 mb-1"><Link className="text-light" to="movie">{movie.title}</Link></h6>
                    <div>
