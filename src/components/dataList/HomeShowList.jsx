                    ...
                    {tvSeriesSuccess && tvSeries.slice(0, 8).map((show, index) => 
                        <div className="col-sm-12 col-md-6 col-lg-4 col-xl-3 col-xxl-3" key={index}>
                            ...
                            <div className="card-body px-0">
                                ...
                                <div>
                                <p className="text_small mb-0 text-white-50">{show.release_date || show.first_air_date}
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-circle-fill mx-2" style={{fontSize: 5}}>
                                        <circle cx={8} cy={8} r={8} />
                                    </svg>series</p>
                                </div>
                            </div>
                            <span className="badge bg-primary position-absolute" style={{top: 10, left: 10}}>{show.vote_average}</span>
