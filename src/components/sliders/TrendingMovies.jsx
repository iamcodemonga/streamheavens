    ...
    return (
        <div className="container-fluid px-md-4">
            ...
            <div className="movie-container d-flex">
                <div className="card movie-card"><a href="/" data-bs-target="#modal-1" data-bs-toggle="modal"><img src="http://template.gentechtreedesign.com/html/streamlab/html/images/background/asset-14.jpeg" alt="movie_image"/></a>
                <div className="card-body px-0">
                    <h6 className="card-title mt-0 mb-1"><a className="text-light" href="/" data-bs-target="#modal-1" data-bs-toggle="modal">This is the title of the movie stupid</a></h6>
                    <div>
                ...
                <div className="card movie-card"><a href="/" data-bs-target="#modal-1" data-bs-toggle="modal"><img src="http://template.gentechtreedesign.com/html/streamlab/html/images/background/asset-15.jpeg" alt='movie_image'/></a>
                <div className="card-body px-0">
                    <h6 className="card-title mt-0 mb-1"><a className="text-light" href="/" data-bs-target="#modal-1" data-bs-toggle="modal">This is the title of the movie stupid</a></h6>
                    <div>
                    <p className="text_small mb-0 text-white-50">1hr 35mins<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-circle-fill mx-2" style={{fontSize: 5}}>
                ...
                <div className="card movie-card"><a href="/" data-bs-target="#modal-1" data-bs-toggle="modal"><img src="http://template.gentechtreedesign.com/html/streamlab/html/images/background/asset-16.jpeg" alt='movie_image'/></a>
                <div className="card-body px-0">
                    <h6 className="card-title mt-0 mb-1"><a className="text-light" href="/" data-bs-target="#modal-1" data-bs-toggle="modal">This is the title of the movie stupid</a></h6>
                    <div>
                    <p className="text_small mb-0 text-white-50">1hr 35mins<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-circle-fill mx-2" style={{fontSize: 5}}>
                ...
                <div className="card movie-card"><a href="/" data-bs-target="#modal-1" data-bs-toggle="modal"><img src="http://template.gentechtreedesign.com/html/streamlab/html/images/background/asset-17.jpeg" alt='movie_image'/></a>
                <div className="card-body px-0">
                    <h6 className="card-title mt-0 mb-1"><a className="text-light" href="/" data-bs-target="#modal-1" data-bs-toggle="modal">This is the title of the movie stupid</a></h6>
                    <div>
                    <p className="text_small mb-0 text-white-50">1hr 35mins<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-circle-fill mx-2" style={{fontSize: 5}}>
                ...
                <div className="card movie-card"><a href="/" data-bs-target="#modal-1" data-bs-toggle="modal"><img src="http://template.gentechtreedesign.com/html/streamlab/html/images/background/asset-18.jpeg" alt='movie_image'/></a>
                <div className="card-body px-0">
                    <h6 className="card-title mt-0 mb-1"><a className="text-light" href="/" data-bs-target="#modal-1" data-bs-toggle="modal">This is the title of the movie stupid</a></h6>
                    <div>
                    <p className="text_small mb-0 text-white-50">1hr 35mins<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-circle-fill mx-2" style={{fontSize: 5}}>
                ...
                <div className="card movie-card"><a href="/" data-bs-target="#modal-1" data-bs-toggle="modal"><img src="http://template.gentechtreedesign.com/html/streamlab/html/images/background/asset-19.jpeg" alt='movie_image'/></a>
                <div className="card-body px-0">
                    <h6 className="card-title mt-0 mb-1"><a className="text-light" href="/" data-bs-target="#modal-1" data-bs-toggle="modal">This is the title of the movie stupid</a></h6>
                    <div>
                    <p className="text_small mb-0 text-white-50">1hr 35mins<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-circle-fill mx-2" style={{fontSize: 5}}>
                ...
                <div className="card movie-card"><a href="/" data-bs-target="#modal-1" data-bs-toggle="modal"><img src="http://template.gentechtreedesign.com/html/streamlab/html/images/background/asset-20.jpeg" alt='movie_image'/></a>
                <div className="card-body px-0">
                    <h6 className="card-title mt-0 mb-1"><a className="text-light" href="/" data-bs-target="#modal-1" data-bs-toggle="modal">This is the title of the movie stupid</a></h6>
                    <div>
                    <p className="text_small mb-0 text-white-50">1hr 35mins<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-circle-fill mx-2" style={{fontSize: 5}}>
                ...
                <div className="card movie-card"><a href="/" data-bs-target="#modal-1" data-bs-toggle="modal"><img src="http://template.gentechtreedesign.com/html/streamlab/html/images/background/asset-21.jpeg" alt='movie_image'/></a>
                <div className="card-body px-0">
                    <h6 className="card-title mt-0 mb-1"><a className="text-light" href="/" data-bs-target="#modal-1" data-bs-toggle="modal">This is the title of the movie stupid</a></h6>
                    <div>
                    <p className="text_small mb-0 text-white-50">1hr 35mins<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-circle-fill mx-2" style={{fontSize: 5}}>
                ...
                <div className="card movie-card"><a href="/"><img src="http://template.gentechtreedesign.com/html/streamlab/html/images/background/asset-22.jpeg" alt='movie_image'/></a>
                <div className="card-body px-0">
                    <h6 className="card-title mt-0 mb-1"><a className="text-light" href="/" data-bs-target="#modal-1" data-bs-toggle="modal">This is the title of the movie stupid</a></h6>
                    <div>
                    <p className="text_small mb-0 text-white-50">1hr 35mins<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-circle-fill mx-2" style={{fontSize: 5}}>
