            ...
            <div className="movie-container d-flex">
                <div className="card movie-card">
                    <a href="/" data-bs-target="#modal-1" data-bs-toggle="modal">
                        <img src="http://template.gentechtreedesign.com/html/streamlab/html/images/background/asset-6.jpeg" alt="movie_img"/>
                    </a>
                <div className="card-body px-0">
                    <h6 className="card-title mt-0 mb-1">
                        <a className="text-light" href="/" data-bs-target="#modal-1" data-bs-toggle="modal">This is the title of the movie stupid</a>
                    </h6>
                    <div>
                ...
                <div className="card movie-card"><a href="/" data-bs-target="#modal-1" data-bs-toggle="modal"><img src="http://template.gentechtreedesign.com/html/streamlab/html/images/background/asset-5.jpeg" alt="movie_image" /></a>
                <div className="card-body px-0">
                ...
                <div className="card movie-card"><a href="/" data-bs-target="#modal-1" data-bs-toggle="modal"><img src="http://template.gentechtreedesign.com/html/streamlab/html/images/background/asset-7.jpeg" alt="movie_image" /></a>
                <div className="card-body px-0">
                    <h6 className="card-title mt-0 mb-1"><a className="text-light" href="/" data-bs-target="#modal-1" data-bs-toggle="modal">This is the title of the movie stupid</a></h6>
                    <div>
                    <p className="text_small mb-0 text-white-50">1hr 35mins<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-circle-fill mx-2" style={{fontSize: 5}}>
                ...
                <div className="card movie-card"><a href="/" data-bs-target="#modal-1" data-bs-toggle="modal"><img src="http://template.gentechtreedesign.com/html/streamlab/html/images/background/asset-8.jpeg" alt="movie_image" /></a>
                <div className="card-body px-0">
                    <h6 className="card-title mt-0 mb-1"><a className="text-light" href="/" data-bs-target="#modal-1" data-bs-toggle="modal">This is the title of the movie stupid</a></h6>
                    <div>
                    <p className="text_small mb-0 text-white-50">1hr 35mins<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-circle-fill mx-2" style={{fontSize: 5}}>
                ...
                <div className="card movie-card"><a href="/" data-bs-target="#modal-1" data-bs-toggle="modal"><img src="http://template.gentechtreedesign.com/html/streamlab/html/images/background/asset-9.jpeg" alt="movie_image"  /></a>
                <div className="card-body px-0">
                    <h6 className="card-title mt-0 mb-1"><a className="text-light" href="/" data-bs-target="#modal-1" data-bs-toggle="modal">This is the title of the movie stupid</a></h6>
                    <div>
                    <p className="text_small mb-0 text-white-50">1hr 35mins<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-circle-fill mx-2" style={{fontSize: 5}}>
                ...
                <div className="card movie-card"><a href="/" data-bs-target="#modal-1" data-bs-toggle="modal"><img src="http://template.gentechtreedesign.com/html/streamlab/html/images/background/asset-11.jpeg" alt="movie_image"  /></a>
                <div className="card-body px-0">
                    <h6 className="card-title mt-0 mb-1"><a className="text-light" href="/" data-bs-target="#modal-1" data-bs-toggle="modal">This is the title of the movie stupid</a></h6>
                    <div>
                    <p className="text_small mb-0 text-white-50">1hr 35mins<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-circle-fill mx-2" style={{fontSize: 5}}>
                ...
                <div className="card movie-card"><a href="/" data-bs-target="#modal-1" data-bs-toggle="modal"><img src="http://template.gentechtreedesign.com/html/streamlab/html/images/background/asset-12.jpeg" alt="movie_image"  /></a>
                <div className="card-body px-0">
                    <h6 className="card-title mt-0 mb-1"><a className="text-light" href="/" data-bs-target="#modal-1" data-bs-toggle="modal">This is the title of the movie stupid</a></h6>
                    <div>
                    <p className="text_small mb-0 text-white-50">1hr 35mins<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-circle-fill mx-2" style={{fontSize: 5}}>
                ...
                <div className="card movie-card"><a href="/" data-bs-target="#modal-1" data-bs-toggle="modal"><img src="http://template.gentechtreedesign.com/html/streamlab/html/images/background/asset-13.jpeg" alt="movie_image"  /></a>
                <div className="card-body px-0">
                    <h6 className="card-title mt-0 mb-1"><a className="text-light" href="/" data-bs-target="#modal-1" data-bs-toggle="modal">This is the title of the movie stupid</a></h6>
                    <div>
                    <p className="text_small mb-0 text-white-50">1hr 35mins<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-circle-fill mx-2" style={{fontSize: 5}}>
