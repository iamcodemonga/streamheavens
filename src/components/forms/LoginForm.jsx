  ...
  return (
    <form className="auth-form" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="mb-3">
            ...
            <input className="form-control" type="email" placeholder="e.g johndoe@gmail.com" value={email} onChange={(e) => setEmail(e.target.value)} />
        </div>
        <div className="mb-4">
            <div className="d-flex align-items-center justify-content-between mb-2">
                <label className="form-label mb-0">Password</label>
                <button className="btn btn-sm text-light" onClick={handleShowPassword} type="button">{show ? "hide" : "show"}</button>
            </div>
        ...
        <div>
            <a className="btn btn-light w-100 mb-3 border-0 py-3 d-none" role="button" href={`/auth/google`} rel="noopener noreferrer">
            ...
            <a className="btn btn-light w-100 mb-3 border-0 btn-fb d-none" role="button" href="google.com" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-facebook me-3 mb-1">
                    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
                </svg>Login with Facebook
            </a>
            <a className="btn btn-light w-100 mb-3 border-0 btn-twitter d-none" role="button" href="google.com" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-twitter me-3 mb-1">
