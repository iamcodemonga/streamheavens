    ...
    return <>
        <aside id="sidebar" className="d-flex justify-content-center align-items-center">
            ...
            <ul className="nav_list">
                ...
                <li><NavLink to="/tvshows" className="active">Tv shows</NavLink></li>
        ...
        <main>
            ...
            <div className="container-fluid pb-5 px-md-4">
                ...
                <div className="col-sm-12 col-md-6 col-lg-4 col-xl-3 col-xxl-3">
                    <div className="card movie-card-grid"><Link to="show"><img src="https://html.nkdev.info/fliqs/assets/images/tv-shows/show-1-390x440.jpg" alt="show_image" /></Link>
